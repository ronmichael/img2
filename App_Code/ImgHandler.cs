...
public class ImgHandler : IHttpHandler
{
    ...
    public void ProcessRequest(System.Web.HttpContext context)
    {
        ...
        ProcessImage(context.ApplicationInstance, context.Response, context.Request);
    ...
    private ImageFormat GetImageFormatOfFile(string filename)
    {

        string extension = "";
        string[] x = filename.Split('.');
        if (x.Length > 0) extension = x[x.Length - 1];
    ...
    private string GetContentTypeOfFile(string filename)
    {
        try
        {
            string[] pieces = filename.Split('.');
            string extension = pieces[pieces.Length - 1].ToLower();
